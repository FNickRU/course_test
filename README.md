...
Проверить собственные логические и алгоритмические способности заниматься профессиональным программированием. 
В случае если я полностью выполнивню все задания (а я выполню, если не забью на это всё), то могу смело продолжать изучать программирование, 
...
В данном курсе используется подход TDD. Инструменты необходимые для прохождения курса: Maven (обернул IntelliJ IDEA), Git, Java 8.
Также от меня добавлен плагин Checkstyle для роверки правильности написания как своего кода, так и тестов ;)
...
Код тестов править нельзя (но я все равно буду, если захочу =Р).
